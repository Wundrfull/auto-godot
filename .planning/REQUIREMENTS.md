...
- [ ] **PROTO-01**: Variant binary codec encodes and decodes all Godot types needed for debugger communication (null, bool, int, float, String, StringName, Vector2, Vector3, Color, NodePath, Object, Array, Dictionary)
