...
from gdauto.formats.values import Color, Vector2
...
def add(
    ...
    Examples:
      ...
      gdauto particle add --scene scenes/main.tscn --name Explosion --preset explosion

      gdauto particle add --scene scenes/player.tscn --name DustTrail --preset dust --parent Player

      gdauto particle add --scene scenes/fx.tscn --name Custom --amount 32 --lifetime 2.0 --continuous
    """
    try:
