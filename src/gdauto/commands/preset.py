...
def create(
    ...
    Examples:
      ...
      gdauto preset create --platform windows --platform web

      gdauto preset create --platform windows --platform linux --platform macos .
    """
    try:
    ...
    try:
        ...
        if not preset_file.exists():
            raise ProjectError(
                ...
                code="NO_PRESETS",
                fix="Create presets with: gdauto preset create --platform windows",
            )
