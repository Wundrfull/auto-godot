...
def create(
    ...
    Examples:
      ...
      gdauto theme create ui/game_theme.tres

      gdauto theme create --base-color "#1a1a2e" --accent-color "#e94560" --font-size 16 ui/dark_theme.tres
    """
    try:
...
def create_stylebox(
    ...
    Examples:
      ...
      gdauto theme create-stylebox --bg-color "#1a1a2e" --corner-radius 8 --margin 12 ui/panel_bg.tres

      gdauto theme create-stylebox --bg-color red --border-color white --border-width 2 ui/alert.tres
    """
    try:
